...
class DirectPurchaseRequest extends AbstractRequest
{
    ...
    public function getData()
    {
        ...
        $data['PSWD']           = $this->getApiUserPassword();
        $data['USERID']         = $this->getApiUserId();
        ...
        if ($alias) {
            ...
            $data['ALIASPERSISTEDAFTERUSE'] = $alias->getAliasPersistedAfterUse();
    ...
    public function sendData($data)
    {
        ...
        /**
         *         $test = '<?xml version="1.0"?><ncresponse
        orderID="1578786717"
        PAYID="3061966318"
        NCERROR="0"
        STATUS="5">
        ...
        return $this->response = new DirectPurchaseResponse($this, $httpResponse);
//        return $this->response = new DirectPurchaseResponse($this, $test);
    }
