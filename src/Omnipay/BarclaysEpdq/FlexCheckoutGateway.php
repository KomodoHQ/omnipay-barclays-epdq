 ...
 */
class FlexCheckoutGateway extends AbstractGateway
{

    public function getName()
    {
        return 'BarclaysEpdqFlexCheckout';
    }
    ...
    public function purchase(array $parameters = array())
    {
        return $this->createRequest(
            '\Omnipay\BarclaysEpdq\Message\FlexCheckoutPurchaseRequest',
    ...
    {
        return $this->createRequest(
            '\Omnipay\BarclaysEpdq\Message\FlexCheckoutCompletePurchaseRequest',
            array_merge($this->parameters->all(), $parameters)
        );
    }
